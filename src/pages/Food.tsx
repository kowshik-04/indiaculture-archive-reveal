    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-accent/5 pt-20">
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-6xl font-bold bg-gradient-accent bg-clip-text text-transparent mb-4">
            {t('food')}
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Savor the diverse flavors and culinary traditions of Indian cuisine
          </p>
        </div>
          ...
          {foods.map((food) => (
            <Card key={food.id} className="group hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 bg-card/80 backdrop-blur-sm border-accent/20">
              ...
              <CardContent className="p-6">
                <CardTitle className="text-xl mb-2 text-foreground">{food.name}</CardTitle>
