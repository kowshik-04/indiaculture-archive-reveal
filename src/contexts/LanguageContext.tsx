...
const translations = {
  ...
  hi: {
    ...
    'map.filter': 'श्रेणी के अनुसार फ़िल्टर',
    'map.all': 'सभी श्रेणियां',
    'languages.en': 'English',
    'languages.hi': 'हिंदी',
    'languages.te': 'తెలుగు',
    'languages.ta': 'தமிழ்',
  ...
  te: {
    ...
    'map.filter': 'వర్గం ద్వారా ఫిల్టర్ చేయండి',
    'map.all': 'అన్ని వర్గాలు',
    'languages.en': 'English',
    'languages.hi': 'हिंदी',
    'languages.te': 'తెలుగు',
    'languages.ta': 'தமிழ்',
  ...
  ta: {
    ...
    'map.filter': 'வகையின் அடிப்படையில் வடிகட்டு',
    'map.all': 'அனைத்து வகைகள்',
    'languages.en': 'English',
    'languages.hi': 'हिंदी',
    'languages.te': 'తెలుగు',
    'languages.ta': 'தமிழ்',
  ...
  kn: {
    ...
    'map.filter': 'ವರ್ಗದ ಮೂಲಕ ಫಿಲ್ಟರ್ ಮಾಡಿ',
    'map.all': 'ಎಲ್ಲಾ ವರ್ಗಗಳು',
    'languages.en': 'English',
    'languages.hi': 'हिंदी',
    'languages.te': 'తెలుగు',
    'languages.ta': 'தமிழ்',
  ...
  ml: {
    ...
    'map.filter': 'വിഭാഗം അനുസരിച്ച് ഫിൽട്ടർ ചെയ്യുക',
    'map.all': 'എല്ലാ വിഭാഗങ്ങളും',
    'languages.en': 'English',
    'languages.hi': 'हिंदी',
    'languages.te': 'తెలుగు',
    'languages.ta': 'தமிழ்',
